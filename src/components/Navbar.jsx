...
import { Sun, Moon, LogOut, LayoutDashboard, Ticket, Menu, X, TrainFront } from "lucide-react"; // 🌟 TrainFront আইকন ইমপোর্ট করা হয়েছে
...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[var(--card)]/80 backdrop-blur-md border-b border-[var(--border)] transition-all duration-300">
            ...
            {isPending ? (
              ...
              <div className="flex items-center space-x-3">
                <Link
                  ...
                  className="flex items-center space-x-1.5 px-4 py-2 text-xs font-black uppercase tracking-wider text-white bg-linear-to-r from-[var(--primary)] to-[var(--secondary)] rounded-xl hover:opacity-95 shadow-xs active:scale-95 transition-all"
                >
              ...
              <div className="flex items-center space-x-3">
                ...
                <Link
                  href="/auth/signup"
                  className="px-4 py-2 text-xs font-black uppercase tracking-wider text-background bg-foreground rounded-xl hover:opacity-90 shadow-xs transition-all active:scale-95"
                >
                  Sign Up
                </Link>
              </div>
      ...
      {/* Mobile Drawer menu */}
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-[var(--border)]/50 bg-[var(--card)]/95 backdrop-blur-md px-4 py-4 space-y-3">
          <Link
            href="/"
          ...
          {isPending ? (
            ...
            <div className="space-y-3">
              ...
              <Link
                href={getDashboardLink()}
                onClick={() => setMobileMenuOpen(false)}
                className="w-full text-center block py-3 text-xs font-black uppercase tracking-wider text-white bg-linear-to-r from-[var(--primary)] to-[var(--secondary)] rounded-xl"
              >
                Go to Dashboard
              </Link>
              <button
