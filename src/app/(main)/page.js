...
const lightImages = [
  ...
  "https://i.ibb.co.com/93t1My9g/image.png", // Scenic Train
  "https://i.ibb.co.com/DjqPMJ6/image.png", // Flight / Airplane
];
...
export default function HomePage() {
    ...
    const fetchHomeData = async () => {
      ...
      try {
        const latestRes = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/api/tickets?limit=8`,
        );
        if (latestRes.ok) {
  ...
  const handleSearch = (e) => {
    ...
    if (searchForm.transportType)
      query.set("transportType", searchForm.transportType);
  ...
  return (
    <div className="space-y-24 pb-24 bg-[var(--background)]">
      ...
      <section className="relative min-h-[720px] lg:h-[720px] w-full flex items-center justify-center py-12 lg:py-0">
        ...
        <div
          className={`absolute inset-0 bg-gradient-to-b transition-all duration-1000 z-10 ${
            isDarkMode
        ...
        <div className="relative lg:absolute lg:inset-0 flex flex-col justify-center items-center text-center px-4 z-20 space-y-8 max-w-6xl mx-auto py-8 lg:py-0">
          <div className="space-y-4">
            ...
            <p className="text-sm sm:text-base text-slate-350 max-w-2xl mx-auto font-medium leading-relaxed">
             Skip the long lines. Unlock seamless, real-time ticket bookings for elite luxury buses, express bullet trains, scenic launch cruises, and regional flights.
            </p>
          </div>
              ...
              >
                {[
                  ...
                  <button
                    key={tab.value}
                    onClick={() =>
                      setSearchForm({ ...searchForm, transportType: tab.value })
                    }
              ...
              >
                ...
                <div className="space-y-2 text-left">
                  ...
                  <DatePicker
                    ...
                    onChange={(dateStr) =>
                      setSearchForm({ ...searchForm, date: dateStr })
                    }
        ...
        <div className="bg-slate-900/5 dark:bg-slate-900/40 border border-slate-200/50 dark:border-slate-800/80 rounded-[32px] p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center shadow-sm">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Our automated network balances seat inventories and filters out
              fraud listings automatically.
            </p>
        ...
        {loadingAds ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="h-80 bg-slate-200 dark:bg-slate-850 animate-pulse rounded-3xl"
              />
            ))}
          </div>
        ) : ads.length === 0 ? (
          <div className="text-center py-16 bg-white dark:bg-slate-950 rounded-3xl border border-slate-200/60 dark:border-slate-850">
            <p className="text-slate-500 text-sm">
              No sponsored tickets currently featured. Check explore panel!
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center max-w-3xl mx-auto space-y-2">
          ...
          <p className="text-xs text-gray-500 leading-relaxed">
            Most sought-after destinations booking right now at promotional
            rates.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            className="relative h-72 rounded-[32px] overflow-hidden group cursor-pointer liftup border border-slate-200/40 dark:border-slate-850/40"
            onClick={() => router.push("/tickets?from=Dhaka&to=Cox's Bazar")}
          >
            <img
              src="/coxs_bazar.png"
            ...
            <div className="absolute bottom-6 left-6 text-white space-y-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider bg-[var(--primary)] px-3.5 py-1.5 rounded-xl mt-1 inline-block shadow-md">
                Starting $25
              </span>
            </div>
          </div>
          ...
          <div
            className="relative h-72 rounded-[32px] overflow-hidden group cursor-pointer liftup border border-slate-200/40 dark:border-slate-850/40"
            onClick={() => router.push("/tickets?from=Dhaka&to=Sylhet")}
          >
            <img
              src="/sylhet.png"
              alt="Dhaka to Sylhet"
          ...
          <div
            className="relative h-72 rounded-[32px] overflow-hidden group cursor-pointer liftup border border-slate-200/40 dark:border-slate-850/40"
            onClick={() => router.push("/tickets?from=Dhaka&to=Chittagong")}
          >
            <img
              src="/chittagong.png"
        ...
        {loadingLatest ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="h-64 bg-slate-200 dark:bg-slate-850 animate-pulse rounded-3xl"
              />
            ))}
          </div>
          ...
          <div className="text-center py-16 bg-white dark:bg-slate-950 rounded-3xl border border-slate-200/60 dark:border-slate-850">
            <p className="text-slate-500 text-sm">
              No ticket schedules listed at the moment.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
      ...
      <section className="bg-slate-900/5 dark:bg-slate-900/30 py-20 border-y border-slate-200/50 dark:border-slate-850">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2">
            <span className="text-xs font-black text-[var(--primary)] uppercase tracking-widest">
              Our Safeguards
            </span>
            <h2 className="text-3xl font-black text-foreground">
              Guaranteed Travel Experience
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4 p-6 liftup bg-[var(--card)] border border-[var(--border)] rounded-[24px] shadow-sm">
              ...
              <h3 className="font-black text-base text-foreground">
                Instant PDF Barcodes
              </h3>
              <p className="text-xs text-gray-500 leading-relaxed font-medium">
                Valid secure tickets generated instantly after checkout. Print
                or keep digital barcodes on any screen.
              </p>
            </div>
            ...
            <div className="space-y-4 p-6 liftup bg-[var(--card)] border border-[var(--border)] rounded-[24px] shadow-sm">
              ...
              <p className="text-xs text-gray-500 leading-relaxed font-medium">
                Transactions handled via standard SSL encryption. Vendors
                receive payouts only after successful commute.
              </p>
            </div>
            ...
            <div className="space-y-4 p-6 liftup bg-[var(--card)] border border-[var(--border)] rounded-[24px] shadow-sm">
              ...
              <p className="text-xs text-gray-500 leading-relaxed font-medium">
                What you see is what you pay. Transparent flat scheduling rates
                directly set by transport operators.
              </p>
            </div>
            ...
            <div className="space-y-4 p-6 liftup bg-[var(--card)] border border-[var(--border)] rounded-[24px] shadow-sm">
              ...
              <h3 className="font-black text-base text-foreground">
                Instant Online Refunds
              </h3>
              <p className="text-xs text-gray-500 leading-relaxed font-medium">
                Cancel schedules directly from passenger portal. Payout refunds
                processed back to banking cards.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-[28px] p-6 space-y-4 shadow-xl shadow-slate-950/5 relative overflow-hidden flex flex-col justify-between h-64 liftup">
            <div className="space-y-4">
              ...
              <p className="text-xs text-foreground/80 leading-relaxed font-medium">
                "Instant barcodes delivered right after checkout. I bypassed the
                standard agent lines at the bus counter completely."
              </p>
            </div>
            <div className="flex items-center space-x-3 pt-4 border-t border-[var(--border)]/50">
              <img
                ...
                className="w-8 h-8 rounded-full border border-[var(--border)]/50 object-cover"
              />
              <div>
                <h4 className="text-xs font-black text-foreground">
                  Tanvir Rahman
                </h4>
                <span className="text-[9px] text-foreground/60 font-bold block uppercase">
                  Verified Passenger
                </span>
              </div>
            </div>
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-[28px] p-6 space-y-4 shadow-xl shadow-slate-950/5 relative overflow-hidden flex flex-col justify-between h-64 liftup">
            <div className="space-y-4">
              ...
              <p className="text-xs text-foreground/80 leading-relaxed font-medium">
                "Stripe payment was extremely straightforward. No issues with
                multiple banking credentials. Very clean interface."
              </p>
            </div>
            <div className="flex items-center space-x-3 pt-4 border-t border-[var(--border)]/50">
              <img
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-[28px] p-6 space-y-4 shadow-xl shadow-slate-950/5 relative overflow-hidden flex flex-col justify-between h-64 liftup">
            <div className="space-y-4">
              ...
              <p className="text-xs text-foreground/80 leading-relaxed font-medium">
                "Refund system worked flawlessly when my plan changed. Cancelled
                with one tap on the panel and got credited fast."
              </p>
            </div>
            <div className="flex items-center space-x-3 pt-4 border-t border-[var(--border)]/50">
              <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[var(--card)] rounded-3xl overflow-hidden border border-[var(--border)] shadow-sm flex flex-col liftup group">
            ...
            <div className="p-6 flex-grow flex flex-col justify-between space-y-4">
              <div className="space-y-2">
                <span className="text-[9px] font-black text-[var(--primary)] tracking-widest uppercase bg-[var(--primary)]/10 px-2 py-0.5 rounded-md">
                  Tips
                </span>
                <h3 className="font-black text-base leading-snug text-foreground">
                  Long-Haul Train Travel Accessories
                </h3>
                <p className="text-xs text-gray-500 font-medium line-clamp-3">
                  Discover essential tech and comfort items that maximize
                  passenger comfort on cross-country rail schedules.
                </p>
              </div>
          ...
          <div className="bg-[var(--card)] rounded-3xl overflow-hidden border border-[var(--border)] shadow-sm flex flex-col liftup group">
            ...
            <div className="p-6 flex-grow flex flex-col justify-between space-y-4">
              <div className="space-y-2">
                ...
                <h3 className="font-black text-base leading-snug text-foreground">
                  Highway Safety Protocols in Commuting
                </h3>
                <p className="text-xs text-gray-500 font-medium line-clamp-3">
                  Standards implemented by top-tier coach vendors in Bangladesh
                  to guarantee sanitized travel spaces.
                </p>
              </div>
              <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider block">
          ...
          <div className="bg-[var(--card)] rounded-3xl overflow-hidden border border-[var(--border)] shadow-sm flex flex-col liftup group">
            <div className="h-48 overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1506012787146-f92b2d7d6d96?auto=format&fit=crop&q=80&w=600"
                className="h-full w-full object-cover group-hover:scale-105 transition-transform duration-500"
              />
            </div>
            <div className="p-6 flex-grow flex flex-col justify-between space-y-4">
              <div className="space-y-2">
                ...
                <h3 className="font-black text-base leading-snug text-foreground">
                  Summer Getaways: Cox's Bazar Guide
                </h3>
                <p className="text-xs text-gray-500 font-medium line-clamp-3">
                  Everything you need to know about food, sightseeing, and
                  optimal hotel reservations during off-season monsoon trips.
                </p>
              </div>
              <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider block">
